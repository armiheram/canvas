window.addEventListener('load', function(){
    ...
    //reconoce cuando la tecla es pulsada
    class InputHandler{
        constructor(game){
            this.game = game;

            // dispara al senir el disparo
            ...
            //siente cuando la tecla se deja de presionar
    ...
    // caracteristicas del proyectil emitido
    class Projectile{
        ...
        // permite ver las cordenadas del dezplasamiento
        update(){
            this.x += this.speed;
        ...
        draw(context){
            if(this.game.debug) context.fillStyle = 'black';
            else context.fillStyle = 'crimson';
            context.fillRect(this.x, this.y, this.width, this.height);
        }
    }

    // contiene las propiedades del jugador como del disparo
    class Player{
        constructor(game){
            this.game = game;
            this.width = 120;
        ...
        //permite los moviemientos alrededor de la pantalla de parte del jugador y contiene la animacion al cambiar de frame
        update(){
        ...
        // permiteaccionar la funcion de disparar
        shootTop(){
            if(this.game.ammo > 0){
    ...
    class Enemy {
        ...
        // permite el dezplasamiento en el juego
        update(){
    ...
    // caracteristicas y parametros del enemigo 1
    ...
    // caracteristicas y parametros del enemigo 2
    ...
    // caracteristicas y parametros del enemigo 3 
    ...
    //contiene las propiedades y funciones del escenario del juego como su movimiento y dezplasamiento
    class Layer {
    ...
    //propiedades y fondos que utiliza el juego
    class Background {
        constructor(game){
            this.game = game;
    ...
    class UI{
        ...
        // contiene detalles de la interfaz
        draw(context){
            context.save();
    ...
    // desde aqui se pueden actualizar algunas funcionalidades del juego
    class Game{
        ...
        // actualiza la aparicion de balas y enemigos
        update(deltaTime){
        ...
        // genera elementos necesarios para el juego
        draw(context){
